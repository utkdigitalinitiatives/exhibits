        ...
        <div>
          <div className="concert-programs-flex">
            <div className="concert-programs-description">
              ...
              <p>This volume of individual printed programs was likely bound especially for Galston, and bears his <a target="_blank" href="https://digital.lib.utk.edu/collections/islandora/object/galston%3A177">“Ex Libris” bookplate</a> on the inside front cover. The composers and works detailed in this volume match the list of concerts written in Galston's hand at the end of the <span className="studybook">Studienbuch</span>. These handwritten lists include a few additional details, for example, about arrangers, but it is not known why Galston transcribed the concert series in detail at the back of the Studienbuch bound volume; the list was not printed in subsequent editions of the <span className="studybook">Studienbuch</span>.</p>
            </div>
          </div>
